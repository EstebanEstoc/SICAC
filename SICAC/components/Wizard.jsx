...
import { modifyCardiacThreshold } from "../reducers/configuration/configurationSlice";
import Authentication from "./Authentication/Authentication";
import CalendarSelector from "./Wizard/CalendarSelector";
import askPermission from "../services/Permissions";
import Selector from "./Wizard/RelativesSelector";
        ...
        <View>
          ...
          >
            ...
            <Text style={styles.smallBlue}>
              Please choose the google calendar you want to use
            </Text>
          </View>
          <View
            style={{
    ...
    },
    {
      content: (
        <View style={styles.container}>
          ...
          <Text style={styles.smallBlue}>
            Please allow access to the following information
          </Text>
          <Button
            title="Accept"
            color="#F64644"
    ...
    },
    {
      content: (
        <View style={styles.container}>
          ...
          <Text style={styles.smallBlue}>
            {" "}
            Please input your information relative to your health. This part can
            be skipped{" "}
          </Text>
      ...
      content: (
        <View style={styles.container}>
          <Text style={styles.bigBlue}>
            Phone number of your general practitioner
          </Text>
    ...
    },
    {
      content: (
        <View>
          ...
          >
            <Text style={styles.bigBlue}>
              Which of theses devices is your smartwatch ?
            </Text>
          </View>
          <View
            style={{
    ...
    },
    {
      content: (
        <View style={styles.container}>
          ...
          <TextInput
            value={configuration.cardiacThreshold}
            onChangeText={(input) => dispatch(modifyCardiacThreshold(input))}
    ...
    },
    {
      content: (
        <View style={styles.container}>
          ...
          <Text style={styles.smallBlue}>
            You can now acces the application
          </Text>
          <Button
            title="FINISH"
            color="#F64644"
